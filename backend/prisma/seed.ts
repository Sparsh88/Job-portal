...
async function main() {
  console.log('🌱 Starting Database Seeding for HireHub-AI...');
  ...
  // 2. Create Recruiter Users & Companies
...
- 3+ years experience with SQL, Python, Tableau/Power BI, and statistical forecasting.`,
  ...
  console.log('✅ Database Seeding Completed Successfully with 20 Jobs across 5 Domain Sections!');
}

main()
  .catch((e) => {
    console.error('❌ Could not connect to PostgreSQL database during seeding:');
